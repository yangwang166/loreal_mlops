...
```
loreal_mlops         <- Root directory. Both monorepo and polyrepo are supported.
│
├── loreal_mlops       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
