...
[ML Config](../loreal_mlops/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore loreal_mlops/databricks-resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-3059735186595105.5.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-5376743997341287.7.azuredatabricks.net#setting/accounts). If
...
Follow the instructions in [loreal_mlops/databricks-resources/README.md](../loreal_mlops/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../loreal_mlops/databricks-resources/README.md)  to propose, test, and deploy
