...
Opening a pull request will trigger a[workflow](../.github/workflows/loreal_mlops-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-3059735186595105.5.azuredatabricks.net#mlflow/models/staging-loreal_mlops-model)
* [Prod workspace registered model](https://adb-5376743997341287.7.azuredatabricks.net#mlflow/models/prod-loreal_mlops-model)
